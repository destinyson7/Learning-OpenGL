...
for face in faces:
    ...
    for i in range(n - 2):
        ...
        print(
            f'{round(vertices[face[i]][0], 10)} {round(vertices[face[i]][2], 10)} {round(vertices[face[i]][1], 10)} {color} {texture1}')
        print(
            f'{round(vertices[face[i+1]][0], 10)} {round(vertices[face[i+1]][2], 10)} {round(vertices[face[i+1]][1], 10)} {color} {texture2}')
        print(
            f'{round(vertices[face[n-1]][0], 10)} {round(vertices[face[n-1]][2], 10)} {round(vertices[face[n-1]][1], 10)} {color} {texture3}')
